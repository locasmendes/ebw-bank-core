<div class="border-2 pt-3 pr-3 pb-3 pl-2 mb-3 input-wrapper relative">
    ...
    <input {{ $attributes }} id="{{ $attributes->get('name') }}" aria-placeholder="{{ $attributes->get('placeholder') }}" class="w-full py-1 pl-1 focus:outline-none focus:bg-ebw-red  focus:bg-opacity-10 transition-colors duration-150" tabindex="0">
