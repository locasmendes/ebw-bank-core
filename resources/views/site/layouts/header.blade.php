<header class="l-header absolute top-0 left-0 right-0 z-50 p-0 lg:px-6 lg:py-5">
        ...
        <div class="h-screen lg:u-h-unset hidden lg:flex flex-col lg:flex-row justify-center lg:justify-between items-center u-bg-folk-light-black lg:u-bg-folk-none js-navbar">
            ...
            <ul class="flex-none lg:flex-1 flex flex-col lg:flex-row items-center justify-center">
                ...
                <li class="my-4 lg:my-8 mx-4">
                    <a class="l-header__nav-link font-bold uppercase p-2 inline-block u-color-folk-white {!! Request::is( 'conheca-o-ebwbank' ) || Request::is( 'passou-ganhou' ) ? '' : 'lg:u-color-folk-black' !!}" href="{{ route('home') }}">
                        Home
                    </a>
                </li>

                <li class="my-4 lg:my-8 mx-4">
                    <a class="l-header__nav-link font-bold uppercase p-2 inline-block u-color-folk-white {!! Request::is( 'conheca-o-ebwbank' ) || Request::is( 'passou-ganhou' ) ? '' : 'lg:u-color-folk-black' !!}" href="{{ route('conheca-ebw') }}">
                        A EBW
                    </a>
                </li>

                <li class="l-dropdown relative my-4 lg:my-8 mx-4">
                    <a class="l-header__nav-link font-bold uppercase p-2 inline-block u-color-folk-white {!! Request::is( 'conheca-o-ebwbank' ) || Request::is( 'passou-ganhou' ) ? '' : 'lg:u-color-folk-black' !!}" href="#">
                        Para seu negócio
                    </a>
                ...
                <li class="my-4 lg:my-8 mx-4">
                    <a class="l-header__nav-link font-bold uppercase p-2 inline-block u-color-folk-white {!! Request::is( 'conheca-o-ebwbank' ) || Request::is( 'passou-ganhou' ) ? '' : 'lg:u-color-folk-black' !!}" href="{{ route('partner-investor') }}">
                        Seja um investidor
                    </a>
                </li>

                <li class="my-4 lg:my-8 mx-4">
                    <a class="l-header__nav-link font-bold uppercase p-2 inline-block u-color-folk-white {!! Request::is( 'conheca-o-ebwbank' ) || Request::is( 'passou-ganhou' ) ? '' : 'lg:u-color-folk-black' !!}" href="{{ route('portal') }}">
                        Blog
                    </a>
                </li>
            </ul>
