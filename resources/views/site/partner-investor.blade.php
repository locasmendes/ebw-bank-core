                ...
                <form action="{{ route('pre-registratation.store') }}" method="POST">
                    ...
                    <div class="flex -mx-5">
                        ...
                        <div class="w-5/12 px-5">
                            ...
                            <label class="text-black text-xl mb-6 input-checkbox" for="between-500-300" value="Entre R$ 500 mil e R$ 300 mil">
                                <input type="radio" name="investment" id="between-500-300">
                                <span></span>
                                Entre R$ 500 mil e R$ 300 mil
                            </label>
                            <label class="text-black text-xl mb-6 input-checkbox" for="between-300-100" value="Entre R$ 300 mil e R$ 100 mil">
                                <input type="radio" name="investment" id="between-300-100">
                                <span></span>
                                Entre R$ 300 mil e R$ 100 mil
                            </label>
                            <label class="text-black text-xl mb-6 input-checkbox" for="between-100-50" value="Entre R$ 100 mil e R$ 50 mil">
                                <input type="radio" name="investment" id="between-100-50">
                                <span></span>
                                Entre R$ 100 mil e R$ 50 mil
                            </label>
                            <label class="text-black text-xl mb-6 input-checkbox" for="between-50-20" value="Entre R$ 50 mil e R$ 20 mil">
                                <input type="radio" name="investment" id="between-50-20">
                                <span></span>
                                Entre R$ 50 mil e R$ 20 mil
                            </label>
                            <label class="text-black text-xl mb-6 input-checkbox" for="below-20" value="Até R$ 20 mil">
                                <input type="radio" name="investment" id="below-20">
                                <span></span>
                               Até R$ 20 mil
                            </label>
                        </div>
