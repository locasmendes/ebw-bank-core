...
use Filament\Forms;
use Filament\Forms\Components\{MultiSelect, Textarea, TextInput};
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                TextInput::make('company_1')->label('Experiência: nome da Empresa 1')->disabled(),
                TextInput::make('function_1')->label('Experiência: função na Empresa 1')->disabled(),
                TextInput::make('company_2')->label('Experiência: nome da Empresa 2')->disabled(),
                TextInput::make('function_2')->label('Experiência: função na Empresa 2')->disabled(),
                TextInput::make('company_3')->label('Experiência: nome da Empresa 3')->disabled(),
                TextInput::make('function_3')->label('Experiência: função na Empresa 3')->disabled(),
                ...
                // FileUpload::make('curriculo')->label('asd')->disk('local')->disabled(),
            ]);
    }
